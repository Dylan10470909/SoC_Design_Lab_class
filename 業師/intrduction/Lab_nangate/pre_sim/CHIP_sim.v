...
initial $sdf_annotate("../genus/outputs/CHIP_syn.sdf",CHIP);
...
//    $fsdbDumpvars;
    ...
    #0 CLK=0;HALT=0;DoDCT=1;X=0;Mode=0;TEST_MODE=0;SCAN_EN=0;RESET_ = 1'b0;
//    @(negedge CLK)  RESET_ = 1'b0;TEST_MODE=1; SCAN_EN=1;
 //   @(negedge CLK)  RESET_ = 1'b1;TEST_MODE=0; SCAN_EN=0;
