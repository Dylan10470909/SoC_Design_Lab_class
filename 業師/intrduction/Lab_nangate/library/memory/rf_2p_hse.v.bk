...
//       
//       Creation Date:  Wed May 30 13:56:35 2018
//       Version: 	r9p1
//
...
`ifdef POWER_PINS
module rf_2p_hse (VDDCE, VDDPE, VSSE, CENYA, AYA, CENYB, AYB, DYB, QA, CLKA, CENA,
    AA, CLKB, CENB, AB, DB, EMAA, EMASA, EMAB, EMAWB, TENA, BENA, TCENA, TAA, TQA,
    TENB, TCENB, TAB, TDB, RET1N, STOVA, STOVB, COLLDISN);
`else
module rf_2p_hse (CENYA, AYA, CENYB, AYB, DYB, QA, CLKA, CENA, AA, CLKB, CENB, AB,
    DB, EMAA, EMASA, EMAB, EMAWB, TENA, BENA, TCENA, TAA, TQA, TENB, TCENB, TAB, TDB,
...
`endif
  ...
  parameter WORDS = 64;
  parameter MUX = 1;
  parameter MEM_WIDTH = 16; // redun block size 1, 8 on left, 8 on right
...
`endif
  ...
  reg NOT_DB2, NOT_DB1, NOT_DB0, NOT_EMAA2, NOT_EMAA1, NOT_EMAA0, NOT_EMASA, NOT_EMAB2;
  reg NOT_EMAB1, NOT_EMAB0, NOT_EMAWB1, NOT_EMAWB0, NOT_TENA, NOT_TCENA, NOT_TAA5;
  reg NOT_TAA4, NOT_TAA3, NOT_TAA2, NOT_TAA1, NOT_TAA0, NOT_TENB, NOT_TCENB, NOT_TAB5;
  reg NOT_TAB4, NOT_TAB3, NOT_TAB2, NOT_TAB1, NOT_TAB0, NOT_TDB15, NOT_TDB14, NOT_TDB13;
 ...
 wire  CLKB_;
  ...
  assign `ARM_UD_DP AYA_ = RET1N_ ? (TENA_ ? AA_ : TAA_) : {6{1'bx}};
  assign `ARM_UD_DP CENYB_ = RET1N_ ? (TENB_ ? CENB_ : TCENB_) : 1'bx;
  assign `ARM_UD_DP AYB_ = RET1N_ ? (TENB_ ? AB_ : TAB_) : {6{1'bx}};
...
`endif
 ...
 wire  CLKB_;
  ...
  buf B8(AYB[0], AYB_[0]);
  buf B9(AYB[1], AYB_[1]);
  buf B10(AYB[2], AYB_[2]);
  buf B11(AYB[3], AYB_[3]);
  buf B12(AYB[4], AYB_[4]);
  buf B13(AYB[5], AYB_[5]);
  buf B14(DYB[0], DYB_[0]);
  buf B15(DYB[1], DYB_[1]);
  buf B16(DYB[2], DYB_[2]);
  buf B17(DYB[3], DYB_[3]);
  buf B18(DYB[4], DYB_[4]);
  buf B19(DYB[5], DYB_[5]);
  buf B20(DYB[6], DYB_[6]);
  buf B21(DYB[7], DYB_[7]);
  buf B22(DYB[8], DYB_[8]);
  buf B23(DYB[9], DYB_[9]);
  buf B24(DYB[10], DYB_[10]);
  buf B25(DYB[11], DYB_[11]);
  buf B26(DYB[12], DYB_[12]);
  buf B27(DYB[13], DYB_[13]);
  buf B28(DYB[14], DYB_[14]);
  buf B29(DYB[15], DYB_[15]);
  buf B30(QA[0], QA_[0]);
  buf B31(QA[1], QA_[1]);
  buf B32(QA[2], QA_[2]);
  buf B33(QA[3], QA_[3]);
  ...
  buf B38(QA[8], QA_[8]);
  buf B39(QA[9], QA_[9]);
  buf B40(QA[10], QA_[10]);
  buf B41(QA[11], QA_[11]);
  buf B42(QA[12], QA_[12]);
  buf B43(QA[13], QA_[13]);
  buf B44(QA[14], QA_[14]);
  buf B45(QA[15], QA_[15]);
  buf B46(CLKA_, CLKA);
  buf B47(CENA_, CENA);
  buf B48(AA_[0], AA[0]);
  buf B49(AA_[1], AA[1]);
  ...
  buf B70(DB_[8], DB[8]);
  buf B71(DB_[9], DB[9]);
  buf B72(DB_[10], DB[10]);
  buf B73(DB_[11], DB[11]);
  buf B74(DB_[12], DB[12]);
  buf B75(DB_[13], DB[13]);
  buf B76(DB_[14], DB[14]);
  buf B77(DB_[15], DB[15]);
  ...
  buf B90(TAA_[0], TAA[0]);
  buf B91(TAA_[1], TAA[1]);
  buf B92(TAA_[2], TAA[2]);
  buf B93(TAA_[3], TAA[3]);
  buf B94(TAA_[4], TAA[4]);
  buf B95(TAA_[5], TAA[5]);
  buf B96(TQA_[0], TQA[0]);
  buf B97(TQA_[1], TQA[1]);
  buf B98(TQA_[2], TQA[2]);
  buf B99(TQA_[3], TQA[3]);
  buf B100(TQA_[4], TQA[4]);
  buf B101(TQA_[5], TQA[5]);
  buf B102(TQA_[6], TQA[6]);
  buf B103(TQA_[7], TQA[7]);
  buf B104(TQA_[8], TQA[8]);
  buf B105(TQA_[9], TQA[9]);
  buf B106(TQA_[10], TQA[10]);
  buf B107(TQA_[11], TQA[11]);
  buf B108(TQA_[12], TQA[12]);
  buf B109(TQA_[13], TQA[13]);
  buf B110(TQA_[14], TQA[14]);
  buf B111(TQA_[15], TQA[15]);
  buf B112(TENB_, TENB);
  buf B113(TCENB_, TCENB);
  buf B114(TAB_[0], TAB[0]);
  buf B115(TAB_[1], TAB[1]);
  buf B116(TAB_[2], TAB[2]);
  buf B117(TAB_[3], TAB[3]);
  buf B118(TAB_[4], TAB[4]);
  buf B119(TAB_[5], TAB[5]);
  buf B120(TDB_[0], TDB[0]);
  buf B121(TDB_[1], TDB[1]);
  buf B122(TDB_[2], TDB[2]);
  buf B123(TDB_[3], TDB[3]);
  buf B124(TDB_[4], TDB[4]);
  buf B125(TDB_[5], TDB[5]);
  buf B126(TDB_[6], TDB[6]);
  buf B127(TDB_[7], TDB[7]);
  buf B128(TDB_[8], TDB[8]);
  buf B129(TDB_[9], TDB[9]);
  buf B130(TDB_[10], TDB[10]);
  buf B131(TDB_[11], TDB[11]);
  buf B132(TDB_[12], TDB[12]);
  buf B133(TDB_[13], TDB[13]);
  buf B134(TDB_[14], TDB[14]);
  buf B135(TDB_[15], TDB[15]);
  buf B136(RET1N_, RET1N);
  buf B137(STOVA_, STOVA);
  buf B138(STOVB_, STOVB);
  buf B139(COLLDISN_, COLLDISN);

  assign CENYA_ = RET1N_ ? (TENA_ ? CENA_ : TCENA_) : 1'bx;
  assign AYA_ = RET1N_ ? (TENA_ ? AA_ : TAA_) : {6{1'bx}};
  assign CENYB_ = RET1N_ ? (TENB_ ? CENB_ : TCENB_) : 1'bx;
  assign AYB_ = RET1N_ ? (TENB_ ? AB_ : TAB_) : {6{1'bx}};
  assign DYB_ = RET1N_ ? (TENB_ ? DB_ : TDB_) : {16{1'bx}};
   `ifdef ARM_FAULT_MODELING
     rf_2p_hse_error_injection u1(.CLK(CLKA_), .Q_out(QA_), .A(AA_int), .CEN(CENA_int), .TQ(TQA_), .BEN(BENA_), .Q_in(QA_int));
  `else
...
`endif
`timescale 1ns/1ps
module rf_2p_hse_error_injection (Q_out, Q_in, CLK, A, CEN, BEN, TQ);
   output [15:0] Q_out;
   input [15:0] Q_in;
   input CLK;
   input [5:0] A;
...
begin
   ...
   `ifdef ARM_NONREPAIRABLE_FAULT
      `pre_pend_path.SMARCHCHKBVCD_LVISION_MBISTPG_ASSEMBLY_UNDER_TEST_INST.MEM0_MEM_INST.u1.add_fault(6'd1,4'd6,2'd1,2'd0);
   `endif
end
   task add_fault;
